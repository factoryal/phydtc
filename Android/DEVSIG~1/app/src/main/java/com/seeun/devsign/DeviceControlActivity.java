...
public class DeviceControlActivity extends Activity {
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        ACTION_GATT_DISCONNECTED: GATT 서버와의 연결이 끊어짐.
        ACTION_GATT_SERVICES_DISCOVERED: 발견된 GATT 서비스.
        ACTION_DATA_AVAILABLE: 장치로부터 수신된 데이터. 읽기 또는 알림 작업의 결과 일 수 있음.*/
    ...
    /*주어진 GATT characteristic이 선택된 경우, 지원되는 기능을 확인.
                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
                    ...
                    if (mGattCharacteristics != null) {
                        ...
                        if ((charaProp | BluetoothGattCharacteristic.PROPERTY_READ) > 0) {
                            ...
                            /*특성에 활성 알림이 있는 경우,
                              먼저 사용자 인터페이스의 데이터 필드를 업데이트 하지 않도록 특성을 지움.*/
                        ...
                        if((charaProp | BluetoothGattCharacteristic.PROPERTY_WRITE) > 0 ){
                            ...
                            if(SampleGattAttributes.UUID_WRITE.equals(characteristic.getUuid().toString())) {
                                Log.e("보냅다", "ㅎㅎ");
                                mBluetoothLeService.writeRemoteCharacteristic(characteristic); //여기서 hi보냄
                            }
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int id) {
                        //final String intensity_val = userInput.getText().toString();
                        final String intensity_val = userInput.getText().toString();
                        //characteristic.setValue(intensity, format, 0);
                        //byte[] bytes = intensity_val.getBytes();
                        //characteristic.setValue(intensity_val);
...
*/
    ...
    * 이 샘플에서는 UI의 ExpandableListView에 바인딩 된 데이터 구조체(연결된 BT기기의 제공서비스들)를 채움.*/
