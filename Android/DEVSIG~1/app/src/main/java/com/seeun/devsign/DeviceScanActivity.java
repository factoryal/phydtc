...
//        getActionBar().setTitle(R.string.title_devices);
        ...
        /*BLE가 장치에서 지원되는지 여부를 결정.
                BLE 관련 기능을 선택적으로 비활성화 할 수 있음.*/
    ...
    /*특정타입의 페어링만 스캔하고자 한다면
    startLeScan(UUID[], BluetoothAdapter.LeScanCallback)을 사용.
    UUID[]에는 앱에서 지원하고자 하는 GATT 서비스 목록이 들어감.*/
